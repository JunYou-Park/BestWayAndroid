...
interface ApiService {
    ...
    fun getToDayDiet(@Query("data") today: Long): Observable<DataResult>
    ...
    @FormUrlEncoded
    @POST("${USER_API}/post_user_ticket.do")
    fun getUserTicket(@Field("data") data: JsonObject): Observable<DataResult>
